 ...
 * @update: 8:21
 * @version: V1.0
 * @detail: 消息消费者，，由于消费的代码被注释掉了
 * 10秒后。消息会从正常队列， TEST_DlX_QUEUE 到达死信交换机 DLX_EXCHANGE，然后路由到死信队列DLX_QUEUE
 **/
public class DlxConsumer {
    ...
    public static void main(String[] args)throws Exception {
        ...
        //arguments.put("x-ecpires","9000");//设置队列的TTL
        //arguments.put("x-max-length",4);//如果设置了队列的最大长度，超过长度时，先入队的消息会被发送到DLX

        //声明队列（默认交换机AMQP default Direct）
        //String queue,boolean durable,boolean exclusive,boolean autoDelete,Map<String,Object> arguments
        channel.queueDeclare("TEST_DEL_QUEUE",false,false,false,arguments);
        ...
        channel.queueBind("DLX_QUIEUE","DLX_EXCHANGE","#");
        System.out.println("Waitiing for message ....");
